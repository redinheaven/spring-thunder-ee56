...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/spring-thunder-ee56
```

A live public deployment of this template is available at [https://spring-thunder-ee56.templates.workers.dev](https://spring-thunder-ee56.templates.workers.dev)
